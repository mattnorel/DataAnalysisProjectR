...
skip_every <- 50
tmp <- imputed_data %>%
          slice(seq(1, nrow(imputed_data), skip_every))
...
for(col in colnames(imputed_data)){
  if(col != "X"){
  plot <- qplot(imputed_data[[col]], xlab=col)
  print(plot)
...
```{r}
  ...
  plot <- qplot(imputed_data$cfin1Changed[imputed_data$cfin1 > 0], xlab="cfin1", binwidth=0.4)
  print(plot)
...
```{r}
  ...
  plot <- qplot(imputed_data$cfin2Changed[imputed_data$cfin2 > 0], xlab="cfin2", binwidth=0.4)
  print(plot)
...
```{r}
  ...
  plot <- qplot(imputed_data$chel1Changed, xlab="chel1", binwidth=0.4)
  print(plot)
...
```{r}
  ...
  plot <- qplot(imputed_data$lcop1Changed, xlab="lcop1", binwidth=0.1)
  print(plot)
