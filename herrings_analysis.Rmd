...
aggr_plot <- aggr(just_with_na, col=c('navyblue','red'), numbers=TRUE, sortVars=TRUE, labels=names(just_with_na), cex.axis=.7, gap=3, ylab=c("Histogram of missing data","Pattern"))
```

```{r}
colormapMiss(just_with_na, interactive = TRUE)
